      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-primary/20 border-l-4 border-primary p-6 rounded-lg">
        ...
        <section className="bg-primary/20 rounded-xl p-8 mb-12 border border-primary/40">
          ...
          <div className="space-y-4 text-base text-white leading-relaxed">
            ...
            <p className="text-lg font-semibold text-primary-light mt-4">
        ...
        <section className="mb-8">
          ...
          <div className="bg-accent/20 rounded-xl p-8 mb-8 border border-accent/40">
            <div className="space-y-4 text-base text-white leading-relaxed">
              <p>
        ...
        {/* CTA Section */}
        <section className="bg-gradient-to-br from-accent to-primary-dark text-white rounded-xl p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="bg-white text-accent px-8 py-4 rounded-md font-semibold hover:bg-tan transition-colors duration-200"
            >
              Get In Touch
            </Link>
            <Link
              href="/resume"
              className="border-2 border-white text-white px-8 py-4 rounded-md font-semibold hover:bg-white hover:text-accent transition-colors duration-200"
            >
              View Resume
            </Link>
          </div>
