      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-4xl font-bold text-[#4A3C2C] dark:text-[#2F241F]">Resume & Skills</h1>
            <a
          ...
          {/* Resume PDF Viewer */}
          <div className="bg-white dark:bg-[#FEFDFB] border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-xl p-6 mb-8">
            <div className="flex items-center gap-3 mb-4">
              <FileText className="text-[#FFC425]" size={28} />
              <h2 className="text-2xl font-semibold text-[#4A3C2C] dark:text-[#2F241F]">Resume</h2>
            </div>
            
            {/* PDF Embed */}
            <div className="border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-lg overflow-hidden">
              <iframe
          ...
          <div className="bg-white dark:bg-[#FEFDFB] border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-[#4A3C2C] dark:text-[#2F241F] mb-4 flex items-center gap-3">
          ...
          {/* Experience Section */}
          <div className="bg-white dark:bg-[#FEFDFB] border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-xl p-8 mb-8">
            <h2 className="text-2xl font-bold text-[#4A3C2C] dark:text-[#2F241F] mb-6 flex items-center gap-3">
            ...
            <div className="space-y-8">
              ...
              <div className="border-l-4 border-[#FFC425] pl-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                  <div>
                    <h3 className="text-xl font-bold text-[#4A3C2C] dark:text-[#2F241F]">Indeed - Glassdoor</h3>
                    <p className="text-lg font-semibold text-[#FFC425]">Functional Lead</p>
                  </div>
                  <div className="text-[#6B5D52] dark:text-[#4A3C2C] font-medium">
                    <p>April 2025 - PRESENT</p>
                    <p className="text-sm">Remote</p>
                  </div>
                </div>
                <p className="text-[#4A3C2C] dark:text-[#2F241F] mb-4">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">AI Model Training & Optimization:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">Content Moderation Leadership & QA Strategy:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                      <li className="flex items-start">
                        <span className="text-[#FFC425] mr-2">•</span>
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">Technical Project Leadership:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                      <li className="flex items-start">
                        <span className="text-[#FFC425] mr-2">•</span>
              ...
              <div className="border-l-4 border-[#D4A849] pl-6">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-3">
                  <div>
                    <h3 className="text-xl font-bold text-[#4A3C2C] dark:text-[#2F241F]">Glassdoor</h3>
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">BPO & Vendor Management:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                      <li className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">Cross-Functional Collaboration:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                      <li className="flex items-start">
                        <span className="text-[#D4A849] mr-2">•</span>
                  ...
                  <div>
                    <h4 className="font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-2">Process Optimization:</h4>
                    <ul className="space-y-2 text-[#4A3C2C] dark:text-[#2F241F] ml-4">
                      <li className="flex items-start">
                        <span className="text-[#D4A849] mr-2">•</span>
          ...
          <div className="bg-white dark:bg-[#FEFDFB] border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-xl p-8 mb-8">
            ...
            <div className="border-l-4 border-[#FFC425] pl-6">
              <h3 className="text-xl font-bold text-[#4A3C2C] dark:text-[#2F241F]">Kent State University</h3>
              <p className="text-lg text-[#4A3C2C] dark:text-[#2F241F] mb-2">Bachelor of Business Administration</p>
              <p className="text-[#6B5D52] dark:text-[#4A3C2C]">Finance Major, Business Management Minor</p>
              <p className="text-[#6B5D52] dark:text-[#4A3C2C] mt-1">August 2009 - May 2013</p>
            </div>
          </div>

          {/* Skills Section */}
          <div className="bg-white dark:bg-[#FEFDFB] border border-[#E8DFD3] dark:border-[#E8DFD3]/50 rounded-xl p-8">
            <h2 className="text-2xl font-bold text-[#4A3C2C] dark:text-[#2F241F] mb-6 flex items-center gap-3">
            ...
            <div className="space-y-8">
              {/* AI & LLM Operations */}
              <div>
                <h3 className="text-lg font-semibold text-[#4A3C2C] dark:text-[#2F241F] mb-3 flex items-center gap-2">
                  <Cpu className="text-[#FFC425]" size={20} />
                  AI & LLM Operations
                </h3>
                <p className="text-[#4A3C2C] dark:text-[#2F241F] leading-relaxed">
